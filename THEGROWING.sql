...
CREATE TABLE CLASS (
	CLASS_NO	NUMBER  DEFAULT SEQ_CNO.NEXTVAL	NOT NULL CONSTRAINT PK_CLASS PRIMARY KEY,
...
CREATE TABLE MEMBER (
	USER_NO	NUMBER   DEFAULT SEQ_MNO.NEXTVAL	NOT NULL CONSTRAINT PK_MEMBER PRIMARY KEY,
...
CREATE TABLE SURVEY (
	SURVEY_NO	NUMBER  DEFAULT SEQ_SNO.NEXTVAL	NOT NULL CONSTRAINT PK_SURVEY PRIMARY KEY,
...
CREATE TABLE BOARD (
	BOARD_NO	NUMBER  DEFAULT SEQ_BNO.NEXTVAL	NOT NULL CONSTRAINT PK_BOARD PRIMARY KEY,
...
CREATE TABLE TIME_TABLE (
	TIME_TABLE_NO	NUMBER  DEFAULT SEQ_TNO.NEXTVAL	NOT NULL CONSTRAINT PK_TIME_TABLE PRIMARY KEY,
	REF_CNO	NUMBER	NOT NULL,
...
CREATE TABLE ATTACHMENT (
	FILE_NO	NUMBER  DEFAULT SEQ_ANO.NEXTVAL	NOT NULL CONSTRAINT PK_ATTACHMENT PRIMARY KEY,
...
CREATE TABLE REPLY (
	REPLY_NO	NUMBER  DEFAULT SEQ_RNO.NEXTVAL	NOT NULL CONSTRAINT PK_REPLY PRIMARY KEY,
	REF_BNO	NUMBER	NOT NULL,
...
CREATE TABLE QUESTION (
	QUES_NO	NUMBER  DEFAULT SEQ_QNO.NEXTVAL	NOT NULL CONSTRAINT PK_QUESTION PRIMARY KEY,
...
CREATE TABLE CHOICE_QUES (
	QUES_NO	NUMBER	NOT NULL CONSTRAINT PK_CHOICE_QUES PRIMARY KEY,
	QUES_TITLE	VARCHAR2(60)	NOT NULL,
	QUES_CONTENT	VARCHAR2(500)	NULL,
    CONSTRAINT FK_QUESTION_TO_CHOICE_QUES_1 FOREIGN KEY (QUES_NO) REFERENCES QUESTION (QUES_NO)
);
...
CREATE TABLE WRITE_QUES (
	QUES_NO	NUMBER	NOT NULL CONSTRAINT PK_WRITE_QUES PRIMARY KEY,
	QUES_TITLE	VARCHAR2(60)	NOT NULL,
	QUES_CONTENT	VARCHAR2(500)	NULL,
    CONSTRAINT FK_QUESTION_TO_WRITE_QUES_1 FOREIGN KEY (QUES_NO) REFERENCES QUESTION (QUES_NO)
);
...
CREATE TABLE CHOICE_OPTION (
    ...
    CONSTRAINT FK_CHOICE_QUES_TO_OPTION_1 FOREIGN KEY (REF_QNO) REFERENCES CHOICE_QUES (QUES_NO)
);
...
COMMENT ON COLUMN CHOICE_OPTION.ITEM_COUNT IS '응답자수';
...
CREATE TABLE WRITE_ANS (
    ...
    CONSTRAINT FK_WRITE_QUES_TO_WRITE_ANS_1 FOREIGN KEY (REF_QNO) REFERENCES WRITE_QUES (QUES_NO),
    CONSTRAINT FK_MEMBER_TO_WRITE_ANS_1 FOREIGN KEY (REF_UNO) REFERENCES MEMBER (USER_NO)
);

COMMENT ON TABLE WRITE_ANS IS '주관식답안';
COMMENT ON COLUMN WRITE_ANS.REF_QNO IS '질문번호';
