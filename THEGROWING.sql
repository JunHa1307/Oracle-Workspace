...
CREATE TABLE LUNCH (
	...
	ATPT_OFCDC_SC_CODE	VARCHAR(3)	NOT NULL,
	SD_SCHUL_CODE	VARCHAR(7)	NOT NULL,
...
COMMENT ON COLUMN LUNCH.ATPT_OFCDC_SC_CODE IS '시도교육청코드';
COMMENT ON COLUMN LUNCH.SD_SCHUL_CODE IS '표준학교코드';
